...
- `lowdim_nonlinear_v1_math` / `lowdim_nonlinear_v1`
- `duffing_aug_snr10`
- `highdim_nonlinear_v2_math` / `highdim_nonlinear_v2`
...
- `experiments/data_generation/generate_lowdim_nonlinear_v1_dataset.jl`
- `experiments/data_generation/generate_duffing_aug_snr10_dataset.jl`
- `experiments/data_generation/generate_highdim_nonlinear_v2_dataset.jl`
...
`src/data/lowdim_nonlinear_v1_generation.jl` already persisted physical-coordinate
...
- Low-dimensional nonlinear smoke and formal generation passed for all eight objects.
